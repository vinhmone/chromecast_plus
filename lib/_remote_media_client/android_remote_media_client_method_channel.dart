...
import 'package:chromecast_plus/entities/cast_media_status.dart';
import 'package:chromecast_plus/entities/load_options.dart';
import 'package:chromecast_plus/entities/media_information.dart';
import 'package:chromecast_plus/entities/queue_item.dart';
import 'package:chromecast_plus/entities/media_seek_option.dart';
import 'package:chromecast_plus/entities/request.dart';
import 'package:chromecast_plus/models/android/android_media_status.dart';
import 'package:chromecast_plus/models/android/android_queue_item.dart';
...
class GoogleCastRemoteMediaClientAndroidMethodChannel
  ...
  final _channel =
      const MethodChannel('com.chaubacho.chromecast_plus.remote_media_client');
