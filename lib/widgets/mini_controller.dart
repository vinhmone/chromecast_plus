...
import 'package:chromecast_plus/widgets/expanded_player.dart';
...
class _GoogleCastMiniControllerState extends State<GoogleCastMiniController> {
  ...
  Widget _image(GoggleCastMediaStatus mediaStatus) {
    ...
    if (metadata?.images != null && metadata!.images!.isNotEmpty) {
      return SizedBox(
        ...
        height: 80,
        child: Hero(
          tag: 'com.chaubacho.chromecast_plus.controller.image',
          child: Image.network(
  ...
  Widget _buildTitle(GoggleCastMediaStatus mediaStatus) {
    ...
    return FittedBox(
      child: Hero(
        tag: 'com.chaubacho.chromecast_plus.controller.title',
        child: Text(
          title,
